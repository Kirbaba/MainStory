...
function add_style(){
    ...
    wp_enqueue_style( 'simple-sidebar', get_template_directory_uri() . '/css/simple-sidebar.css', array(), '1');    
...
function add_script(){
    ...
    wp_enqueue_script( 'youtubebackground', get_template_directory_uri() . '/js/jquery.youtubebackground.js', array(), '1');
